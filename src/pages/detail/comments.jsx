...
// data yı neden import ettik

// gönderiien videoda yorumlar bulunmadığı için api ye istek atıyoruz.
// bunun içinde state de bilgileri tutuyoruz.
const Comments = ({ videoId }) => {
  const [comments, setComments] = useState(null);
  const [loading, setLoading] = useState(true);
  const [error, setError] = useState(null);
  //   apiden comment bölümüne istek atıyoruz.
  useEffect(() => {
    api
  ...
  //   her video yenilendiğinde api den bilgileri almasını sağlıyor
  ...
  return (
    <div className="my-6">
      ...
      />
      {/* yorumları listelemek gerekir.bu yüzden map leriz. */}
      <div>
          ...
          >
            ...
            <div>
              ...
              <div className="flex items-center gap-3 mt-2">
                ...
                <span className="comment-field font-[600] text-xs">
                  yanıtla
                </span>
              </div>
            </div>
